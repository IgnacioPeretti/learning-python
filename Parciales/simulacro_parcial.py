...
while True:
    ...
    print("Bienvenido al programa de control de registro mensual")

    controlador = int(input("Ingrese 1 para comenzar o 0 para salir del programa."))

    if int(controlador) == 1:
